  ...
  <div class="body-wrapper">
   ...
   <jsp:include page="aside.jsp"></jsp:include>
	...
	<table class="table">
	  <thead>
	    <tr>
	      <th scope="col" style="position:relative; font-weight:bold; right:140px">SL NO</th>
	      <th scope="col" style="position:relative;font-weight:bold; right:20px">Name</th>
	      <th scope="col" style="position:relative; font-weight:bold; right:40px">Email</th>
	      <th scope="col" style="position:relative; font-weight:bold; right:40px">Password</th>
	  ...
	  for(User us : allusers)
	  {
		  ...
		  out.println("<td>"+ us.getUser_name() +"</td>");
		  out.println("<td>"+ us.getUser_email() +"</td>");
		  out.println("<td>"+ us.getUser_password() +"</td>");
