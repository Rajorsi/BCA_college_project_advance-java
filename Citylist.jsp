...
%>
	...
	<table class="table" >
	  <thead>
	    <tr>
	      <th scope="col" style="position:relative; font-weight:bold; right:20px">SL NO</th>
	  ...
	  for(City ct : allcity)
	  {
			  ...
			  out.println("<td><button type='button' class='btn btn-primary'><i class='bx bxs-edit'></i><a href='editCity.jsp?city_id="+ct.getCity_id()+"'style='color:white; font-weight:bold'>Edit</a></button>  |<button type='button' class='btn btn-danger'><i class='bx bx-trash'></i> <a onclick='deleteC("+ct.getCity_id()+")'>Delete</a></button></td>");		
			  out.println("</tr>");
			  i++;
