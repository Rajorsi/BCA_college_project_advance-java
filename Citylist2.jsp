...
<%
City p =new City();
ArrayList<City> allcity = p.showallcity();
%>
	
	<table class="table" >
	  <thead>
	    <tr>
	      <th scope="col" style="position:relative; font-weight:bold; right:30px">SL NO</th>
	      <th scope="col" style="position:relative; font-weight:bold; right:40px">Photo</th>
	      <th scope="col" style="position:relative;font-weight:bold; left:0px">City Name</th>
	      <th scope="col" style="position:relative;font-weight:bold; left:0px">Status</th>
	      <th scope="col" colspan="3" style="position:relative; font-weight:bold; right:60px">Action</th>
	    </tr>
	  </thead>
	  <tbody>
	  <%
	  ...
	  for(City ct : allcity)
	  {
		  ...
		  out.println("<td style='width:56%'><img src='cityImage/"+ct.getCity_image()+"'style='width:20%'></td>");
		  out.println("<td>"+ ct.getCity_name()+"</td>");
		  out.println("<td>"+ ct.getStatus()+"</td>");
		  out.println("<td><button type='button' class='btn btn-primary'><i class='bx bxs-edit'></i><a href='editCity2.jsp?city_id="+ct.getCity_id()+"'style='color:white; font-weight:bold'>Edit</a></button>  |<button type='button' class='btn btn-danger'><i class='bx bx-trash'></i> <a onclick='deleteC("+ct.getCity_id()+")'>Delete</a></button></td>");
