...
<script src="assets/js/preloader.js"></script>
  <div class="body-wrapper">
   ...
   <jsp:include page="aside2.jsp"></jsp:include>
    ...
    <form class="addplace" action="uploadP" method="post"  enctype="multipart/form-data">
        <h2>Add New State</h2>
       ...
       <input type="hidden" name="typeofuser" value="user"></input>
	     ...
	     <div class="input-box">
	      ...
	      <div class="input-box">
	       <input type="file" class="form-control" id="place_image" name="place_image" onchange="getImgData()" required>
	       
	       <i class='bx bxs-photo-album'></i>
	     </div>
    
    	<div class="input-box">
	       <input type="text" class="form-control" id="place_description" name="place_description" onchange="getImgData()" required>
