  ...
  <div class="body-wrapper">
   ...
   <jsp:include page="aside2.jsp"></jsp:include>
	...
	<table class="table">
	  ...
	  {
		  if(st.getStatus().equals("accepted"))
		  {
		  out.println("<tr>");
		  ...
		  out.println("<td><button type='button' class='btn btn-primary'><i class='bx bxs-edit'></i><a href='editState2.jsp?state_id="+st.getState_id()+"' style='color:white; font-weight:bold'>Edit</a></button> | <button type='button' class='btn btn-danger'><i class='bx bx-trash'></i><a onclick='deleteSt("+st.getState_id()+")' style='color:white; font-weight:bold'>Delete</a></button></td>");
