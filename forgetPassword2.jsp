    ...
    <nav class="navbar navbar-expand-lg ">
	 ...
	 <div id="loading"></div>
      <form class="form" onsubmit="event.preventDefault(); sendOTP();" id="sendotp">
        <div class="mb-3">
          <label for="user_email" class="form-label m-2">Email address</label>
      ...
      <form class="form" onsubmit="event.preventDefault(); resetPassword();" id="resetpassword">
        <div class="mb-3">
          <label for="user_password" class="form-label m-2">Enter Password</label>
      ...
      <script>
      	...
      	function resetPassword()
      	{
			...
			$.ajax({
				url:"resetpassword2",
				method:"post",
				data:{"user_password": user_password, "cpassword": cpassword},
				success: function(response)
				{
					loading.style.display = 'none';
