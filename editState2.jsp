...
.body{
    ...
    align-items: center;
    min-height: 100vh;
  	background: url(css2/ph.jpg)no-repeat;
    width: 100%;
}
  ...
  <div class="body-wrapper">
   ...
   <jsp:include page="aside2.jsp"></jsp:include>
    ...
    <div class="main-wrapper mdc-drawer-app-content">
	  ...
	  state details = st.byid();
	  %>
	        	<div class="body">	
         	 <div class="login-box">
    
    <form class="addstate" action="uploadstate" method="post"  enctype="multipart/form-data">
        <h2>Add New State</h2>
       
         <div class="input-box">
	       <input type="text" class="form-control" id="state_id" name="state_id" value="<%=state_id%>"> 
	       <label for="state_id" class="form-label">State ID</label>  
	       <i class='bx bxs-plane-alt'></i><br> <br>
	     </div>
       
	     <div class="input-box">
	       <input type="text" class="form-control" id="state_name" name="state_name" required value="<%out.println(details.getState_name());%>" > 
	       <label for="state_name" class="form-label">Enter State Name</label>  
	       <i class='bx bxs-plane-alt'></i><br> <br>
	     </div>
	        
	      <div class="input-box">
	       <input type="file" class="form-control" id="state_image" name="state_image" onchange="getImgData()" required value="<%out.println(details.getState_image());%>">
